import pandas as pd
players20 = pd.read_excel('players_final_22_good.xlsx')
...
cluster_centers_df_good = pd.DataFrame(cluster_centers, columns=features)
print(cluster_centers_df_good)
...
cluster_players_good = players20[['DISPLAY_FI_LAST', 'cluster']]
...
pd.plotting.parallel_coordinates(cluster_centers_df_good, 'Class', colormap='viridis')
plt.show()

# Create a data frame containing our centroids
centroids = pd.DataFrame(kmeans.cluster_centers_, columns=players20[features].columns)
centroids['cluster'] = centroids.index

pd.plotting.parallel_coordinates(centroids, colormap='viridis')
