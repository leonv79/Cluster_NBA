import pandas as pd
players20 = pd.read_excel('players_final_22_bad.xlsx')
...
#dfg.sort_values(ascending=True)
...
cluster_centers_df_bad = pd.DataFrame(cluster_centers, columns=features)
print(cluster_centers_df_bad)
...
cluster_players_bad = players20[['DISPLAY_FI_LAST', 'cluster']]
